...
#import "MGLMetalStyleLayer_Private.h"

#import "MGLMapView_Private.h"
#import "MGLStyle_Private_Metal.h"
...
@implementation MGLMetalStyleLayer
...
- (instancetype)initWithIdentifier:(NSString *)identifier {
    auto layer = std::make_unique<mbgl::style::CustomLayer>(identifier.UTF8String,
                                                            std::make_unique<MGLMetalLayerHost>(self));
...
class MGLMetalLayerHost : public mbgl::style::CustomLayerHost {
public:
    MGLMetalLayerHost(MGLMetalStyleLayer *styleLayer) {
        layerRef = styleLayer;
        layer = nil;
    }
...
private:
    __weak MGLMetalStyleLayer * layerRef;
    MGLMetalStyleLayer * layer = nil;
};

namespace mbgl {

MGLStyleLayer* MetalStyleLayerPeerFactory::createPeer(style::Layer* rawLayer) {
    return [[MGLMetalStyleLayer alloc] initWithRawLayer:rawLayer];
}
